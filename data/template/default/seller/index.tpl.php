<?php if (!defined('IN_DSXCMS')) die('Access Denied!');?><?php include template('header'); ?><div class="wellcome-div">
    ...
    <a href="/?m=<?php echo $_G[m];?>&c=wallet&a=recharge" class="button btn-recharge">我要充值</a>
</div>
<div class="mcenter-content-div" style="height:120px;">
	<div class="headimg-div">
    	<div class="avatar"><img src="<?php echo avatar($_G[uid]); ?>"></div>
        <div class="a-setting"><a href="/?m=<?php echo $_G[m];?>&c=setting&a=modiinfo">设置头像</a></div>
    </div>
    <div class="user-account">
        ...
        <div class="row">
        	<div class="item"><a href="/?m=<?php echo $_G[m];?>&c=setting&a=modiinfo"><span class="icon">&#xf0199;</span>修改个人资料</a></div>

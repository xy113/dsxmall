<?php if (!defined('IN_DSXCMS')) die('Access Denied!');?>
  </div>
</div>
  <script type="text/javascript">
    $("img[rel=setimage]").setImage(function(o,data){
      var url = $(o).attr('data-action');
      url = typeof(url) !== 'undefined' ? url : '<?php echo U("c=$G[c]&a=setimage"); ?>';
  ...
  $(function () {
    $("#side-menu dl").each(function () {
      var _this = this;
      $(this).find('dd').on('click', function (e) {
        $(_this).find('dt').toggle();
      });
...
<script src="/static/js/dsxcms.js" type="text/javascript"></script>
<div id="footer">
  <p></p>

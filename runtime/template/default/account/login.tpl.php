        ...
        <div class="content" id="loginView">
            ...
            <div class="sign-content">
                <form method="post" id="loginForm" autocomplete="off">
                    <input type="hidden" id="J_refer" name="refer" value="<?php echo $redirect;?>">
...
<script type="text/javascript">
    ...
    function scanQuery() {
        $.ajax({
            dataType:'json',
            url:"<?php echo U('m=account&c=login&a=scan_query'); ?>",
    ...
    function confirmLogin() {
        $.ajax({
            dataType:'json',
            url:"<?php echo U('m=account&c=login&a=confirm_login'); ?>",
            beforeSend:function () {
                $("#loading").show();
            },
            success:function (response) {
    ...
    $(function () {
        function checkLogin() {
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo U('m=account&c=login&a=chklogin&inajax=1'); ?>",
                async:false,
                dataType:"json",
        ...
        $("#saoma-login").on('click', function () {
            $("#loginView").hide();
            $("#saomaView").show();
            $("#qrcode").attr("src","<?php echo U('m=account&c=login&a=qrcode'); ?>");
            scanQuery();
        });
